...
export const DigitalDetailsModal = ({ album, onClose, onUpdateSuccess, onArtistClick, onNext, onPrev }: any) => {
  ...
  // --- INTELIGENTNY PARSER TRACKLISTY ---
                  ...
                  <div className="flex-1 overflow-y-auto overscroll-contain p-6 md:p-12 lg:px-24 no-scrollbar space-y-12 md:space-y-16" style={{ WebkitOverflowScrolling: 'touch' }}>
                    ...
                    <section className="space-y-6 pb-12">
                      ...
                      <div className="pt-4 space-y-2 text-left">
                        ...
                        <textarea className="w-full bg-black/40 border border-white/10 rounded-2xl px-5 py-4 text-xs font-mono text-zinc-400 outline-none focus:border-brand/50 transition-all h-40 resize-none no-scrollbar shadow-inner" value={form.tracks} placeholder="Np. 1. Intro - 3:45&#10;Side A&#10;A1. Piosenka" onChange={e => setForm({...form, tracks: e.target.value})} />
                      </div>
                    </section>
                  </div>
