...
function App() {
  return (
    <BrowserRouter>
      {/* Pasek nawigacji - teraz statyczny, przewija się z treścią */}
...
// Pomocniczy komponent linku z aktywnym stanem
const ArchiveLink = ({ to, label }: { to: string, label: string }) => (
  <NavLink 
    to={to} 
    className={({ isActive }) => `
      text-[10px] font-black uppercase tracking-[0.3em] transition-all px-4 py-2 rounded-full border
      ${isActive 
